...
const nombre_alumno = "Soy Angel Villa mi programa termono las: ";
...
btnGenerar.addEventListener('click', () => {
    ...
    if (correo === "" || !correo.includes('@')) {
        alert("Por favor, introduce un correo electrónico válido.");
         console.error("No pusiste el arroba, ponte listo !!!!")
        return;
    }
    ...
    console.log("la accioon de conversion de token a sido correcta")
